...
To begin assembling the system, you need to prepare the PCB (Printed Circuit Board) with the following [circuit](SEHMA/Arduino_Nano+A6mini_GPRS/Hardware/PCB_Datos2.pdf). If you're unsure how to prepare it, click [here](https://youtu.be/MX9_9U6Wnu8?si=8ijrH3XqB462RJCx&t=36).
...
Now, the next step is to upload the [program](SEHMA/Arduino_Nano+A6mini_GPRS/Firmware/Estacion_v1.4_1hora/Estacion_v1.4_1hora.ino) to the Arduino. To install the libraries, follow the steps in this [tutorial](https://docs.arduino.cc/software/ide-v1/tutorials/installing-libraries/) for importing .zip [libraries](SEHMA/Arduino_Nano+A6mini_GPRS/Firmware/Estacion_v1.4_1hora/Librerias/). Insert each component (ensuring they are functioning correctly) into their respective places. Place the chip in the modem and the battery in the RTC as shown [here](Imagenes/PCB/Posicion%20Pila%20RTC.jpg).
